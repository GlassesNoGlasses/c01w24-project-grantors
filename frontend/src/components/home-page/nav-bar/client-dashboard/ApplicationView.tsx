        ...
        <div className="py-10 px-10">
            ...
            shadow-2xl shadow-black">
                <div id="view-header" className="px-8 py-4">
                    <p className="text-xl font-bold mb-6">Congratulations! Your grant has been approved.</p>
                    <p className="text-xl font-bold">Application Information</p>
                </div>
                <div className="flex flex-col px-8 gap-4">
                    ...
                    <Link to="/" className="bg-primary py-2 px-8 w-fit text-base text-white hover:bg-secondary rounded-lg mt-4 ml-2">
                        Home
                    </Link>
                </div>
            </div>
